    ...
    <section className="before:fixed before:w-full before:h-screen before:bg-gray-50 before:top-0 before:left-0 before:-z-10">
      ...
      <section className="grid items-center">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
          <div className="bg-white shadow-md dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12 mb-8">
            ...
            <Link
              to="/"
              className="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-500 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"
            >
              Leer más
              <svg
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white shadow-md dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 md:p-12">
              <a
                href="#"
